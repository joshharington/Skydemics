...
@section('page-title')
    Create a Lesson | Lecturer <small><a href="{{ route('courses.builder.lessons', $course->id) }}">Back to {{ $course->name }} lessons</a></small>
@endsection
...
@section('content')
    ...
    <div class="tabbable paper-shadow relative" data-z="0.5" id="tabs">
        ...
        <div class="tab-content">
            <form action="{{ route('courses.builder.lessons.create', [$course->id, $module->id]) }}" method="POST" id="builder-form" enctype="multipart/form-data">
