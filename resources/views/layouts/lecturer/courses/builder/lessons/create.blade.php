...
@section('site-title')
    Create a Lesson | Lecturer
@endsection

@section('page-title')
    Create a Lesson | Lecturer <small><a href="{{ route('courses.builder.lessons', $course->slug) }}">Back to {{ $course->name }} lessons</a></small>
@endsection
...
@section('content')
    ...
    <div class="tabbable paper-shadow relative" data-z="0.5" id="tabs">
        ...
        <div class="tab-content">
            <form action="{{ route('courses.builder.lessons.create', [$course->slug, $module->slug]) }}" method="POST" id="builder-form" enctype="multipart/form-data">
                <div id="lesson" class="tab-pane active">

                    <div class="col-md-7">
                        <div class="form-group form-control-material">
                            <input type="text" name="title" id="title" placeholder="Lesson Title" class="form-control used" value="{{ old('title') }}" />
                ...
                <div id="meta" class="tab-pane">
                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            <br />
                            <div class="form-group form-control-material">
                                <input type="text" placeholder="Attendance Code" class="form-control" id="attendance_code" aria-describedby="attendance_code" name="attendance_code" value="{{ (old('attendance_code')) ? old('attendance_code') : str_random(4) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <div data-type="requires_attendance" class="checkbox checkbox-info checkbox-circle">
                                <input id="requires_attendance" type="checkbox" checked name="requires_attendance" {{ (old('requires_attendance')) ? 'checked' : '' }}>
